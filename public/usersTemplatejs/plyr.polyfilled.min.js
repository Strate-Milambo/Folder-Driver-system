"object" == typeof navigator && function(e, t) {
            ...
            var t = e.URL
              , i = function(t, i) {
                ...
                if (i && (void 0 === e.location || i !== e.location.href)) {
                    ...
                    try {
                        if (0 !== s.href.indexOf(i))
                            throw new Error(s.href)
                    } catch (e) {
                ...
                a.href = t,
                s && (n.body.appendChild(a),
                a.href = a.href);
                var r = n.createElement("input");
                if (r.type = "url",
                r.value = t,
                ":" === a.protocol || !/:/.test(a.href) || !r.checkValidity() && !i)
    ...
    var f = function() {
        function e(t, i) {
            ...
            p.element(this.element) && p.empty(this.element.rangeTouch) && (this.config = a({}, r, {}, i),
            this.init())
        }
    ...
    function O(e, t, i) {
        ...
        return A.object(t) && I(s, t),
        A.string(i) && (s.innerText = i),
        s
    }
    function $(e, t, i, s) {
    ...
    function D(e, t) {
        return A.element(t) && A.element(t.parentNode) && A.element(e) ? (t.parentNode.replaceChild(e, t),
        e) : null
    }
    function q(e, t) {
        if (!A.string(e) || A.empty(e))
            return {};
        const i = {}
          , s = N({}, t);
    ...
    function H(e, t) {
        if (!A.element(e))
            return;
        let i = t;
        A.boolean(i) || (i = !e.hidden),
        e.hidden = i
    }
    function F(e, t, i) {
        if (A.nodeList(e))
            return Array.from(e).map((e=>F(e, t, i)));
        if (A.element(e)) {
            let s = "toggle";
    ...
    const oe = [[1, 1], [4, 3], [3, 4], [5, 4], [4, 5], [3, 2], [2, 3], [16, 10], [10, 16], [16, 9], [9, 16], [21, 9], [9, 21], [32, 9], [9, 32]].reduce(((e,[t,i])=>({
        ...e,
        [t / i]: [t, i]
    })), {});
    function le(e) {
        if (!(A.array(e) || A.string(e) && e.includes(":")))
            return !1;
    ...
    function he(e) {
        ...
        const [s,n] = ce(i)
          , a = 100 / s * n;
        if (re(`aspect-ratio: ${s}/${n}`) ? t.style.aspectRatio = `${s}/${n}` : t.style.paddingBottom = `${a}%`,
    ...
    const me = {
                ...
                set(t) {
                    if (e.quality !== t) {
                        if (e.config.quality.forced && A.function(e.config.quality.onChange))
                            ...
                            ("none" !== a || r) && (e.once("loadedmetadata", (()=>{
                                e.speed = o,
                                e.currentTime = s,
                                n || se(e.play())
                            }
        ...
        cancelRequests() {
            this.isHTML5 && (j(me.getSources.call(this)),
    ...
    const Me = {
        ...
        findElements() {
            try {
                return this.elements.controls = W.call(this, this.config.selectors.controls.wrapper),
        ...
        createButton(e, t) {
            ...
            case "play-large":
                ...
                break;
            default:
                A.empty(n.label) && (n.label = s),
                A.empty(n.icon) && (n.icon = e)
            }
            const a = O(n.element);
            ...
            I(a, i),
            "play" === s ? (A.array(this.elements.buttons[s]) || (this.elements.buttons[s] = []),
        ...
        createMenuItem({value: e, list: t, type: i, title: s, badge: n=null, checked: a=!1}) {
            ...
            Object.defineProperty(o, "checked", {
                ...
                set(e) {
                    e && Array.from(o.parentNode.children).filter((e=>V(e, '[role="menuitemradio"]'))).forEach((e=>e.setAttribute("aria-checked", "false"))),
        ...
        updateVolume() {
            this.supported.ui && (A.element(this.elements.inputs.volume) && Me.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
            A.element(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume))
        },
        setRange(e, t=0) {
            A.element(e) && (e.value = t,
            Me.updateRangeFill.call(this, e))
        },
        updateProgress(e) {
        ...
        updateSeekTooltip(e) {
            var t, i;
            if (!this.config.tooltips.seek || !A.element(this.elements.inputs.seek) || !A.element(this.elements.display.seekTooltip) || 0 === this.duration)
                return;
        ...
        updateSetting(e, t, i) {
            ...
            if (A.element(a) || (a = s && s.querySelector('[role="menu"]')),
            !A.element(a))
                return;
        ...
        setQualityMenu(e) {
            ...
            if (Me.toggleMenuButton.call(this, t, s),
            R(i),
        ...
        setCaptionsMenu() {
            ...
            const e = "captions"
              ...
              , s = Boolean(i.length);
            if (Me.toggleMenuButton.call(this, e, s),
            R(t),
            Me.checkMenu.call(this),
            !s)
                return;
        ...
        toggleMenu(e) {
            ...
            if (!A.element(t) || !A.element(i))
                return;
            const {hidden: s} = t;
            let n = s;
            if (A.boolean(e))
                n = e;
            else if (A.keyboardEvent(e) && "Escape" === e.key)
                n = !1;
            else if (A.event(e)) {
        ...
        showMenuPanel(e="", t=!1) {
            ...
            H(n, !0),
            H(i, !1),
            Me.focusFirstMenuItem.call(this, i, t)
        },
        setDownloadUrl() {
        ...
        create(e) {
            ...
            A.array(this.config.controls) && this.config.controls.includes("play-large") && this.elements.container.appendChild(i.call(this, "play-large"));
            ...
            return ne(A.array(this.config.controls) ? this.config.controls : []).forEach((r=>{
                if ("restart" === r && c.appendChild(i.call(this, "restart", u)),
                ...
                if ("current-time" === r && c.appendChild(a.call(this, "currentTime", u)),
                ...
                if ("captions" === r && c.appendChild(i.call(this, "captions", u)),
                "settings" === r && !A.empty(this.config.settings)) {
                    ...
                    this.config.settings.forEach((i=>{
                        ...
                        u.appendChild(O("span", {
                            "aria-hidden": !0
                        }, we.get(i, this.config))),
                        u.appendChild(O("span", {
                            class: this.config.classNames.hidden
                        }, we.get("menuBack", this.config))),
                        J.call(this, c, "keydown", (e=>{
                ...
                if ("pip" === r && Y.pip && c.appendChild(i.call(this, "pip", u)),
        ...
        inject() {
            ...
            A.element(this.config.controls) || A.string(this.config.controls) ? e = this.config.controls : (e = Me.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
            ...
            if (s[A.element(e) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", e),
        ...
        setMarkers() {
            ...
            s.appendChild(n),
            this.config.tooltips.seek || (a = O("span", {
                class: this.config.classNames.tooltip
            }, ""),
            s.appendChild(a)),
    ...
    const Ne = {
        setup() {
            ...
            var e, t;
            if (A.element(this.elements.captions) || (this.elements.captions = O("div", q(this.config.selectors.captions)),
            ...
            if (A.boolean(n) || ({active: n} = this.config.captions),
        ...
        update() {
            ...
            (a && this.language !== i || !e.includes(n)) && (Ne.setLanguage.call(this, i),
            Ne.toggle.call(this, t && a)),
        ...
        getLabel(e) {
            let t = e;
            return !A.track(t) && Y.textTracks && this.captions.toggled && (t = Ne.getCurrentTrack.call(this)),
    ...
    class He {
        ...
        static get prefix() {
            if (A.function(document.exitFullscreen))
                return "";
            let e = "";
            return ["webkit", "moz", "ms"].some((t=>!(!A.function(document[`${t}ExitFullscreen`]) && !A.function(document[`${t}CancelFullScreen`])) && (e = t,
            !0))),
            e
        }
        static get property() {
        ...
        get active() {
            ...
            if (!He.nativeSupported || this.forceFallback)
                return U(this.target, this.player.config.classNames.fullscreen.fallback);
    ...
    const Ue = {
        ...
        build() {
            ...
            A.element(this.elements.controls) || (Me.inject.call(this),
        ...
        setTitle() {
            ...
            if (A.string(this.config.title) && !A.empty(this.config.title) && (e += `, ${this.config.title}`),
        ...
        setPoster(e, t=!0) {
            ...
            ie.call(this).then((()=>Fe(e))).catch((t=>{
                throw e === this.poster && Ue.togglePoster.call(this, !1),
                t
            }
            )).then((()=>{
                if (e !== this.poster)
        ...
        constructor(e) {
            t(this, "firstTouch", (()=>{
                const {player: e} = this
                  , {elements: t} = e;
                e.touch = !0,
                F(t.container, e.config.classNames.isTouch, !0)
            }
            )),
            t(this, "global", ((e=!0)=>{
                const {player: t} = this;
            ...
            t(this, "container", (()=>{
                ...
                J.call(e, i.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", (t=>{
                    ...
                    n.hover = !1);
                    let a = 0;
                    ["touchstart", "touchmove", "mousemove"].includes(t.type) && (Ue.toggleControls.call(e, !0),
                    a = e.touch ? 3e3 : 2e3),
                ...
                const n = ()=>{
                    ...
                    t.style.height = c ? "100%" : "auto") : (t.style.maxWidth = c ? l / a * n + "px" : null,
                ...
                J.call(e, i.container, "enterfullscreen exitfullscreen", (t=>{
                    ...
                    if (s !== i.container)
                        return;
                    if (!e.isEmbed && A.empty(e.config.ratio))
                        return;
                    n();
            ...
            t(this, "media", (()=>{
                const {player: e} = this
                  , {elements: t} = e;
                if (J.call(e, e.media, "timeupdate seeking seeked", (t=>Me.timeUpdate.call(e, t))),
            ...
            t(this, "controls", (()=>{
                ...
                this.bind(t.buttons.settings, "keyup", (t=>{
                    ...
                    t.stopPropagation(),
                    Me.toggleMenu.call(e, t)) : Me.focusFirstMenuItem.call(e, null, !0))
                }
                ), null, !1),
                ...
                this.bind(t.inputs.seek, "mousedown mouseup keydown keyup touchstart touchend", (t=>{
                    const i = t.currentTarget
                      , s = "play-on-seeked";
                    if (A.keyboardEvent(t) && !["ArrowLeft", "ArrowRight"].includes(t.key))
                        return;
                    e.lastSeekTime = Date.now();
                    const n = i.hasAttribute(s)
                      , a = ["mouseup", "touchend", "keyup"].includes(t.type);
                    n && a ? (i.removeAttribute(s),
                    se(e.play())) : !a && e.playing && (i.setAttribute(s, ""),
                    e.pause())
                }
                )),
                x.isIos) {
                ...
                this.bind(t.controls, "focusin", (()=>{
                    ...
                    clearTimeout(s.controls),
                    s.controls = setTimeout((()=>Ue.toggleControls.call(e, !1)), n)
                }
                )),
    ...
    var Be = function(e, t) {
        ...
        e.exports = function() {
            ...
            function o(t, i, s, n) {
                var a, r, l = document, c = s.async, u = (s.numRetries || 0) + 1, h = s.before || e, d = t.replace(/[\?|#].*$/, ""), m = t.replace(/^(css|img)!/, "");
                n = n || 0,
                /(^css!|\.css$)/.test(d) ? ((r = l.createElement("link")).rel = "stylesheet",
                r.href = m,
                (a = "hideFocus"in r) && r.relList && (a = 0,
                r.rel = "preload",
                r.as = "style")) : /(^img!|\.(png|gif|jpg|svg|webp)$)/.test(d) ? (r = l.createElement("img")).src = m : ((r = l.createElement("script")).src = t,
                r.async = void 0 === c || c),
    ...
    const Ke = {
        setup() {
            ...
            e.options.speed = e.config.speed.options,
            he.call(e),
            A.object(window.Vimeo) ? Ke.ready.call(e) : We(e.config.urls.vimeo.sdk).then((()=>{
                Ke.ready.call(e)
            }
            )).catch((t=>{
        ...
        ready() {
            ...
            let a = e.media.getAttribute("src")
              , r = "";
            A.empty(a) ? (a = e.media.getAttribute(e.config.attributes.embed.id),
            r = e.media.getAttribute(e.config.attributes.embed.hash)) : r = function(e) {
            ...
            const l = Le({
              ...
              , c = (u = a,
            A.empty(u) ? null : A.number(Number(u)) ? u : u.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : u);
            var u;
            const h = O("iframe")
            ...
            Object.defineProperty(e.media, "currentTime", {
                ...
                set(t) {
                    ...
                    s.seeking = !0,
                    ee.call(e, s, "seeking"),
                    Promise.resolve(r && i.setVolume(0)).then((()=>i.setCurrentTime(t))).then((()=>r && i.pause())).then((()=>r && i.setVolume(a))).catch((()=>{}
                    ))
                }
            });
    ...
    const Xe = {
        setup() {
            if (F(this.elements.wrapper, this.config.classNames.embed, !0),
        ...
        ready() {
            ...
            if (!A.empty(i) && i.startsWith("youtube-"))
                return;
            let s = e.media.getAttribute("src");
            A.empty(s) && (s = e.media.getAttribute(this.config.attributes.embed.id));
            const n = (a = s,
            A.empty(a) ? null : a.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : a);
            var a;
            const r = O("div", {
                id: `${e.provider}-${Math.floor(1e4 * Math.random())}`,
                "data-poster": t.customControls ? e.poster : void 0
            });
            if (e.media = D(r, e.media),
            t.customControls) {
                ...
                events: {
                    ...
                    onStateChange(i) {
                        ...
                        case 0:
                            ...
                            s.playVideo()) : ee.call(e, e.media, "ended");
                            break;
                        case 1:
                            t.customControls && !e.config.autoplay && e.media.paused && !e.embed.hasPlayed ? e.media.pause() : (Ye.call(e, !0),
                            ee.call(e, e.media, "playing"),
      ...
      , Je = {
        setup() {
            this.media ? (F(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0),
            ...
            this.isVideo && (this.elements.wrapper = O("div", {
            ...
            this.isHTML5 ? me.setup.call(this) : this.isYouTube ? Xe.setup.call(this) : this.isVimeo && Ke.setup.call(this)) : this.debug.warn("No media element found!")
        }
    };
    class Ge {
        constructor(e) {
            ...
            t(this, "on", ((e,t)=>(A.array(this.events[e]) || (this.events[e] = []),
            ...
            t(this, "clearSafetyTimer", (e=>{
                A.nullOrUndefined(this.safetyTimer) || (this.player.debug.log(`Safety timer cleared from: ${e}`),
    ...
    class it {
        constructor(e) {
            ...
            t(this, "startScrubbing", (e=>{
                (A.nullOrUndefined(e.button) || !1 === e.button || 0 === e.button) && (this.mouseDown = !0,
            ...
            t(this, "endScrubbing", (()=>{
                this.mouseDown = !1,
                Math.ceil(this.lastTime) === Math.ceil(this.player.media.currentTime) ? this.toggleScrubbingContainer(!1) : Z.call(this.player, this.player.media, "timeupdate", (()=>{
    ...
    const st = {
        ...
        change(e) {
            L(e, "sources.length") ? (me.cancelRequests.call(this),
            this.destroy.call(this, (()=>{
                ...
                A.empty(e.previewThumbnails) || (Object.assign(this.config.previewThumbnails, e.previewThumbnails),
    ...
    class nt {
        constructor(e, i) {
            if (t(this, "play", (()=>A.function(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then((()=>this.ads.play())).catch((()=>se(this.media.play()))),
            ...
            t(this, "stop", (()=>{
                ...
                this.restart()) : A.function(this.media.stop) && this.media.stop()
            }
            )),
            t(this, "restart", (()=>{
                this.currentTime = 0
            ...
            t(this, "toggleControls", (e=>{
                if (this.supported.ui && !this.isAudio) {
                    ...
                    if (s && A.array(this.config.controls) && this.config.controls.includes("settings") && !A.empty(this.config.settings) && Me.toggleMenu.call(this, !1),
                    s !== t) {
            ...
            t(this, "destroy", ((e,t=!1)=>{
                ...
                const i = ()=>{
                    ...
                    this.embed = null,
                    t ? (Object.keys(this.elements).length && (j(this.elements.buttons.play),
            ...
            this.config = N({}, _e, nt.defaults, i || {}, (()=>{
                try {
            ...
            A.element(this.elements.container) || (this.elements.container = O("div"),
            _(this.media, this.elements.container)),
            Ue.migrateStyles.call(this),
            Ue.addStyleHook.call(this),
            Je.setup.call(this),
            this.config.debug && J.call(this, this.elements.container, this.config.events.join(" "), (e=>{
            ...
            this.lastSeekTime = 0,
            this.config.previewThumbnails.enabled && (this.previewThumbnails = new it(this))) : this.debug.error("Setup failed: no support")
        }
        get isHTML5() {
        ...
        set download(e) {
            A.url(e) && (this.config.urls.download = e,
            Me.setDownloadUrl.call(this))
        }
        set poster(e) {
        ...
        set ratio(e) {
            this.isVideo ? A.string(e) && le(e) ? (this.config.ratio = ce(e),
            he.call(this)) : this.debug.error(`Invalid aspect ratio specified (${e})`) : this.debug.warn("Aspect ratio can only be set for video")
        }
        set autoplay(e) {
        ...
        static setup(e, t={}) {
            let i = null;
            return A.string(e) ? i = Array.from(document.querySelectorAll(e)) : A.nodeList(e) ? i = Array.from(e) : A.array(e) && (i = e.filter(A.element)),
            A.empty(i) ? null : i.map((e=>new nt(e,t)))
        }
    }
    var at;
    return nt.defaults = (at = _e,
